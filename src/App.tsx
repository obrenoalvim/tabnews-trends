...
export default function App() {
  return (
    <div className="boot-flicker flex h-screen flex-col overflow-hidden">
      <header className="relative overflow-hidden border-accent-dim/30 border-b px-6 py-5">
        <div className="blueprint-grid grain pointer-events-none absolute inset-0" />
        <h1 className="text-shadow-glow font-mono text-2xl font-semibold text-accent">
          &gt; tabnews_trends
      ...
      <main className="grid min-h-0 flex-1 auto-rows-fr grid-cols-1 gap-4 overflow-hidden p-4 lg:grid-cols-[1fr_380px]">
        <section className="border-accent-dim/30 relative min-h-[420px] min-w-0 overflow-hidden rounded border bg-black/30">
